...
class InitializationProvider extends ChangeNotifier {
  ...
  Future<void> initialize(BuildContext context) async {
    ...
    try {
      ...
      final settingsService = Provider.of<OrganizationSettingsService>(context, listen: false);
      
      final orgData = await organizationService.getOrganization(user.organizationId!);
      final orgSettings = await settingsService.getOrganizationSettings(user.organizationId!);
      ...
      await productionDataProvider.initialize(
        organizationId: user.organizationId!,
        userId: user.uid,
        batchService: Provider.of<ProductionBatchService>(context, listen: false),
        phaseService: Provider.of<PhaseService>(context, listen: false),
        statusService: Provider.of<ProductStatusService>(context, listen: false),
        clientService: Provider.of<ClientService>(context, listen: false),
        catalogService: Provider.of<ProductCatalogService>(context, listen: false),
